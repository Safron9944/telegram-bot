    ...
    def serialize_catalog(self, auth: AuthContext, *, include_stage_1: bool = True) -> dict[str, Any]:
        ...
        for bank in visible_attestation_banks:
            ...
            attestation_banks.append({
                ...
                "count": len(bank.qids),
                "practice_count": sum(
                    1 for qid in bank.qids
                    if qid in self.qb.by_id and self.qb.by_id[qid].is_open_practice
                ),
...
MINI_APP_START_TEXT = (
    "<b>Підготовка до атестації митників — в одному застосунку.</b>\n\n"
    "Тестування, митні компетенції та навчальні матеріали доступні після натискання кнопки."
)
