...
class AdminUsersUiTests(unittest.TestCase):
    ...
    def test_admin_screen_has_current_cache_version(self):
        ...
        self.assertIn("static/app.js?v=20260820-remove-legacy-stage1-11", index)
        self.assertIn("static/styles.css?v=20260820-remove-legacy-stage1-11", index)
        self.assertIn("static/js/app.js?v=20260820-remove-legacy-stage1-11", entry)
        self.assertIn("styles/components.css?v=20260820-remove-legacy-stage1-11", styles)
        self.assertIn("screens/admin.js?v=20260820-remove-legacy-stage1-11", module)
