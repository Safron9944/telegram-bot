...
class CustomsPreviewAssetsTests(unittest.TestCase):
    ...
    def test_preview_assets_have_fresh_cache_version(self):
        ...
        self.assertIn("20260815-ukrainian-language-01", index)
        self.assertIn("20260815-ukrainian-language-01", app)
        self.assertIn("screens/user.js?v=20260815-ukrainian-language-01", module)
